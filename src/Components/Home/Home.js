...
const Home = () => {
    ...
    return (
        <div className="div-home-wrapper">
            ...
            <div className="div-home-seminars" data-aos="zoom-in">
                <Separator header={<label>Seminars <br /> Attended</label>}

                    content={
                        <div className="div-separator-seminar">
                            <div className="div-separator-seminar-title" data-aos="flip-up" data-aos-duration="1500">
                                <div>Introduction to Cyber Security and PNPK</div>
                                <div>DICT and PICTO</div>
                                <div style={{ fontWeight: "normal" }}>August 28, 2020</div>
                            </div>

                            <div className="div-separator-seminar-title" data-aos="flip-up" data-aos-duration="1500">
                                <div>Student Leader’s Summit</div>
                                <div>Polytechnic University of the Philippines</div>
                                <div style={{ fontWeight: "normal" }}>Feb 08, 2019 – Feb 09, 2019</div>
                            </div>
                        </div>
                    } />
            </div>

            <div className="div-home-tertiary" data-aos="zoom-in">
                <Separator header="Tertiary"

                    content={
                        <div className="div-separator-tertiary">
                            <div className="div-separator-tertiary-title" data-aos="flip-up" data-aos-duration="1500">
                                <div>Polytechnic University of the Philippines Bataan Branch</div>
                                <div>Bachelor of Science in Information Technology</div>
                                <div style={{ fontWeight: "normal" }}>S.Y. (2017 to 2021)</div>
                            </div>
                        </div>
                    } />
            </div>
